...
const (
	UserService_SayHello_FullMethodName = "/userpb.UserService/SayHello"
)
...
func (UnimplementedUserServiceServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
